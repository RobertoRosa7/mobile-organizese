...
export enum actionsTypes {
  ...
  ERROR_PUT_DASHBOARD = '[ERROR_PUT_DASHBOARD]',
  ERROR_PUT_CONSOLIDADO = '[ERROR_PUT_CONSOLIDADO]',
  ERROR_PUT_GRAPH_OUTCOME_INCOME = '[ERROR_PUT_GRAPH_OUTCOME_INCOME]',
  ERROR_PUT_LASTDATE_OUTCOME = '[PUT_LASTDATE_OUTCOME]',
  ERROR_GRAPH_OUTCOME_INCOME = '[ERROR_GRAPH_OUTCOME_INCOME]',
